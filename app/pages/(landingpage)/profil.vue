  ...
  <UContainer class="py-12 space-y-12">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
      <div class="lg:col-span-8 space-y-8">
        <UCard>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <p
                class="text-xs text-neutral-800 uppercase font-semibold tracking-wider"
              >
                {{ key }}
              </p>
            ...
            <div class="md:col-span-2 pt-4 border-t border-neutral-800">
              <div
                class="text-xs text-neutral-500 uppercase font-semibold mb-3"
              >
                Batas Wilayah
              </div>
              <div
                class="grid grid-cols-2 md:grid-cols-4 gap-4 text-neutral-700"
              >
                <div
                  v-for="(v, k) in profileData.sections.general.boundaries"
                  :key="k"
                  class="bg-neutral-100 p-3 rounded-lg border border-neutral-800"
                >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <UCard>
            ...
            <div class="space-y-4">
              <div
                class="flex justify-between items-end border-b border-neutral-800 pb-2"
              >
                <span class="text-sm text-neutral-800"
                  >Total Kepala Keluarga</span
                >
          ...
          <UCard>
            ...
            <div class="space-y-4">
              <div>
                <div class="text-xs text-neutral-800 mb-2 uppercase">
                  Fasilitas Umum
                </div>
              ...
              <div>
                ...
                <ul
                  class="text-sm text-neutral-600 list-disc list-inside space-y-1"
                >
                  <li
      ...
      <div class="lg:col-span-4 space-y-8">
        <div
          class="aspect-3/4 rounded-2xl overflow-hidden border border-neutral-800 bg-neutral-900 group"
        >
          <img
