...
<template>
  ...
  >
    ...
    <section
      v-intersect class="py-32 bg-white relative"
    >
      <UContainer>
    ...
    <section
      v-intersect class="bg-neutral-50 py-32 relative overflow-hidden"
    >
    ...
    <section
      v-intersect class="py-32 bg-neutral-950 text-white relative overflow-hidden"
    >
      <UContainer class="relative z-10">
        <div
